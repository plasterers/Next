...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi,我是一个工程,Hi,我是一个打工人,Hi,我是一个搬砖人,欢迎来到建筑知识库的博客📢',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '建筑博客,施工方案,施工组织设计,项目管理,工程资料',// 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'tangshan.team@foxmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://weibo.com/hebts', // 你的微博个人主页
  ...
  ANALYTICS_51LA_ID: process.env.NEXT_PUBLIC_ANALYTICS_51LA_ID || '3HzjdChlC9Lvrgz2', // id，在51la后台获取 
  ANALYTICS_51LA_CK: process.env.NEXT_PUBLIC_ANALYTICS_51LA_CK || '3HzjdChlC9Lvrgz2', // ck，在51la后台获取
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-4901517560411917', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  ADSENSE_GOOGLE_SLOT_IN_ARTICLE: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_IN_ARTICLE || '7516920912', // Google AdScene>广告>按单元广告>新建文章内嵌广告 粘贴html代码中的data-ad-slot值
  ADSENSE_GOOGLE_SLOT_FLOW: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_FLOW || '6012267550', // Google AdScene>广告>按单元广告>新建信息流广告
  ADSENSE_GOOGLE_SLOT_NATIVE: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_NATIVE || '9735572910', // Google AdScene>广告>按单元广告>新建原生广告
  ADSENSE_GOOGLE_SLOT_AUTO: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '2456165923', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '一个建筑知识库的博客', // 站点描述，被notion中的页面描述覆盖
